...
import com.schoollog.attendance.camera.domain.LiveFramePipeline
...
import com.schoollog.attendance.ml.recognition.LocalFaceMatcher
...
fun CameraPreview(
    ...
    allowDebugMockRecognition: Boolean,
    schoolId: String,
    ...
    val frameProcessor = remember(
        ...
        LiveFramePipeline(
            ...
            faceMatcher = LocalFaceMatcher(faceEmbeddingRepository),
            debugFaceMatcher = PlaceholderFaceMatcher(),
    ...
    LaunchedEffect(context, lifecycleOwner, previewView, frameProcessor) {
        onCameraStatusChanged("Starting camera")
        ...
        try {
            ...
            onCameraStatusChanged("Front camera live")
